      ...
      <Col lg={12} md={12} sm={12} className="col-xs-12 item">
        <div className="blog">
          ...
          <div className="content">
            ...
            <p>{text}</p>
            <Link to="#" className="blog-btn">read more <i className="fa  fa-arrow-circle-o-right"></i></Link>
          </div>
        </div>
      </Col>
    )
            ...
            <Row>
              <div className="blog-slider">
                <OwlCarousel ref="carousel" options={options}>
                  {
                    data.map((obj, i) => (
                      <Items key={i} image={obj.image} title={obj.title} date={obj.date} text={obj.text} />
                    ))
                  }
                </OwlCarousel>
              </div>
