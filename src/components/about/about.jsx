      ...
      <Row>
        <Col lg={6} md={6} sm={12} className="col-xs-12">
          <div className="about-content">
            ...
            <p>
              <span className="f-bold">SION</span> multifunctional
              online platform based on blockchain technology. Blockchain
              technology futuristic hud background with world globe and
              blockchain polygon peer to peer network. Global cryptocurrency
              fintech business banner concept.
            </p>
            <p>
              Blockchain technology futuristic hud background with world globe
              and blockchain polygon peer to peer network. Global cryptocurrency
              fintech business banner concept.
            </p>
            <p>
              Blockchain technology futuristic hud background with world globe
          ...
          <Col lg={6} md={6} sm={12} className="col-xs-12">
            <div className="about-content">
              ...
              <ReactWOW animation={this.props.animate} duration="1.3s">
                <p>
                  <span className="f-bold">SION</span>{" "}
                  multifunctional online platform based on blockchain
                  technology. Blockchain technology futuristic hud background
                  with world globe and blockchain polygon peer to peer network.
                  Global cryptocurrency fintech business banner concept.
                </p>
              </ReactWOW>
              <ReactWOW animation={this.props.animate} duration="1.6s">
                <p>
                  Blockchain technology futuristic hud background with world
                  globe and blockchain polygon peer to peer network. Global
                  cryptocurrency fintech business banner concept.
                </p>
              </ReactWOW>
